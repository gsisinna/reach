 ...
 */
#include "reach_core/plugins/impl/sum_factory.h"
...
const rclcpp::Logger LOGGER =
    rclcpp::get_logger("reach.sum_factory");
}
...
double SumFactory::calculateScore(
...
PLUGINLIB_EXPORT_CLASS(reach::plugins::SumFactory,
